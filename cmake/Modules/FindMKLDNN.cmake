...
IF(NOT MKLDNN_FOUND)
  ...
  IF(NOT APPLE AND NOT WIN32 AND NOT BUILD_LITE_INTERPRETER)
    ...
    IF(DEFINED ENV{DNNL_GRAPH_BUILD_COMPILER_BACKEND})
      ...
      message("-- Will build Graph Compiler as well")
    ENDIF(DEFINED ENV{DNNL_GRAPH_BUILD_COMPILER_BACKEND})
  ...
  ELSE(BUILD_ONEDNN_GRAPH)
    FIND_PATH(MKLDNN_INCLUDE_DIR dnnl.hpp dnnl.h dnnl_graph.hpp PATHS ${MKLDNN_ROOT} PATH_SUFFIXES include/oneapi/dnnl)
