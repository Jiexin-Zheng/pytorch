...
from torch._inductor.fx_passes.ipex_onednn_graph_fusion import onednn_graph_fuse_fx, ipex_post_pass_for_onednn_graph
...
# use the following command line to the demo file
# export ONEDNN_GRAPH_VERBOSE=1 && python ipex_demo.py
